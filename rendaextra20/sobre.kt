...
import kotlinx.android.synthetic.main.content_sobre.*

class sobre : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun sobrevoltar(){
        sobre_voltar.setOnClickListener{
            val intent = Intent(this, home::class.java)
            startActivity(intent)
            finish()
        }
